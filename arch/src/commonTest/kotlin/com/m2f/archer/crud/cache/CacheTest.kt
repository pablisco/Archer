...
class CacheTest : BehaviorSpec({
    ...
    Given("A main get data source and a store data source") {
        ...
        When("Calling cache passing StoreSyncOperation") {
            ...
            Then("The repository should be GetRepository") {
                repository.shouldBeInstanceOf<GetRepository<Int, String>>()
            }
        }
        ...
        When("Calling cache passing MainOperation") {
            ...
            Then("The repository should be Repository") {
                repository.shouldBeInstanceOf<Repository<Failure, Int, String>>()
            }
